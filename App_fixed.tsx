...
export default function App() {
  ...
  const ApiPage = () => {
   ...
   useEffect(() => {
     if (formattedText) {
       setCurrentStep(5); // Final - processo completo
     } else if (isReformatting) {
       setCurrentStep(4); // Fase 5: Formatação final
     } else if (isAnalyzingFootnotes) {
       setCurrentStep(3); // Fase 4: Análise de footnotes
   ...
   }, [isProcessing, isAnalyzingFootnotes, isReformatting, formattedText, file, progress]);
         ...
         return (
           <div className="w-full space-y-6">
             <DetailedStatus
               ...
               isAnalyzingFootnotes={isAnalyzingFootnotes}
  ...
  return (
    <>
        ...
        <div className="min-h-screen flex flex-col items-center p-4 sm:p-6 lg:p-8 font-sans">
          <div className="w-full max-w-7xl mx-auto">
            ...
            <div className="mb-6 flex flex-col items-center">
              ...
              />
              {!pdfApiKey && (
                <p className="text-red-600 text-sm mt-1">Please enter your API Key to process the PDF.</p>
              )}
            </div>
      ...
      <div className={`fixed bottom-0 left-0 right-0 bg-gray-100 dark:bg-gray-800 border-t z-50 transition-all duration-300 ${debugMinimized ? 'h-12' : 'max-h-48'}`}>
        ...
        {!debugMinimized && (
          <div className="px-4 pb-4 overflow-auto" style={{ maxHeight: '180px' }}>
